  ...
  operation: {
    ...
    inputFields: [
      ...
      },
      {
        ...
        type: "string",
        helpText:
          "Select Default Owner Id for Deal. Optionally provide Owner Email or Name below to auto-map from Projetly user list; if not found, this selection is used.",
      ...
      },
      {
        ...
        type: "string",
        helpText:
          "Select the deal pipeline this deal belongs to. The stage dropdown below will load from this pipeline.",
      ...
      },
      {
        ...
        type: "datetime",
        helpText: "Enter the start date of the deal.",
        required: false,
        list: false,
        altersDynamicFields: false,
      },
      {
        ...
        label: "Deal: Due Date",
        type: "datetime",
        helpText: "Enter the expected close / due date of the deal.",
        required: false,
        list: false,
        altersDynamicFields: false,
      },
      {
        ...
        type: "number",
        helpText: "Enter the expected total monetary value of this deal.",
        required: false,
        list: false,
        altersDynamicFields: false,
      },
